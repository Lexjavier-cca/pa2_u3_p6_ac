...
public class AuditorActualizacionInterceptor{
    @AroundInvoke
    public Object auditar(InvocationContext ctx) throws Exception{
        System.out.println("Iniciando la auditoria del metodo actualilzar");
        ...
        try{
            ...
            System.out.println("Finalizando la auditoria del metodo actualizar");
