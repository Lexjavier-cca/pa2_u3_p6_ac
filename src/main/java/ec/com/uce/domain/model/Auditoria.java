...
public class Auditoria extends PanacheEntityBase{
    ...
    public Auditoria(Integer id, String nombreMetodo, String argumento, LocalDateTime fechaHoraEjecucion,
    ...
    public String toString() {
        return "Auditoria [id=" + id + ", nombreMetodo=" + nombreMetodo + ", argumento=" + argumento
